...
export const SearchCard = () => {
    return (
        <div className="search-card">
            <div className="img">
                <div className="save">
                    <svg fill="none" viewBox="0 0 683 683" height="683" width="683" className="svg">
                        <g clip-path="url(#clip0_993_25)">
                            <mask height="683" width="683" y="0" x="0" maskUnits="userSpaceOnUse"
                                style={{ maskType: "luminance" }} id="mask0_993_25">
            ...
            <div className="text">
                ...
                <div className="icon-box">
                    <svg style={{ enableBackground: 'new 0 0 512.001 512.001' }}
                        viewBox="0 0 512.001 512.001" y="0px" x="0px"
                        id="Capa_1" className="svg" version="1.1">
                        <g>
                            <path d="M165,68.715l-26.327-26.327l37.363-37.363c3.739-3.739,9.801-3.739,13.54,0l12.786,12.786
		c3.739,3.739,3.739,9.801,0,13.54L165,68.715z" style={{ fill: '#3D6687' }}></path>
                            <path d="M234.998,101.725l-26.327-26.327l37.363-37.363c3.739-3.739,9.801-3.739,13.54,0l12.786,12.786
		c3.739,3.739,3.739,9.801,0,13.54L234.998,101.725z" style={{ fill: '#3D6687' }}></path>
                            <path d="M445.507,349.222l26.327,26.327l37.363-37.363c3.739-3.739,3.739-9.801,0-13.54l-12.787-12.787
		c-3.739-3.739-9.801-3.739-13.54,0L445.507,349.222z" style={{ fill: '#3D6687' }}></path>
                            <path d="M408.054,279.224l26.327,26.327l37.363-37.363c3.739-3.739,3.739-9.801,0-13.54l-12.786-12.786
		c-3.739-3.739-9.801-3.739-13.54,0L408.054,279.224z" style={{ fill: '#3D6687' }}></path>
                        </g>
                        <g>
                            <path d="M443.378,458.836L276.261,234.948L52.372,67.83c-7.845-5.856-8.673-17.309-1.75-24.232
		...
		l-22.953,22.953C460.688,467.51,449.234,466.683,443.378,458.836z" style={{ fill: "#CCDFED" }}></path>
                            <path d="M181.785,507.029L104.93,404.848L2.75,327.993c-3.349-2.518-3.694-7.418-0.73-10.381l11.782-11.782
		...
		C189.203,510.722,184.303,510.378,181.785,507.029z" style={{ fill: "#CCDFED" }}></path>
                        </g>
                        <g>
                            <path d="M209.448,465.784l-17.656-39.003l0,0L180.8,437.772c-9.575,9.575-25.407,8.461-33.546-2.361
		...
		c2.518,3.349,7.418,3.694,10.381,0.73l11.783-11.783C211.887,488.038,214.078,476.012,209.448,465.784z" style={{ fill: '#BAD5E5' }}></path>
                            <path d="M497.749,427.311c0.462-0.999,0.894-2.01,1.261-3.045c0.754-2.12,1.283-4.309,1.628-6.528
		...
		C493.61,434.588,496.005,431.079,497.749,427.311z" style={{ fill: '#BAD5E5' }}></path>
                        </g>
                        <path d="M104.914,432.283L104.914,432.283c-17.494,8.348-35.767-9.925-27.419-27.419l0,0
	...
	C180.009,390.03,143.799,413.73,104.914,432.283z" style={{ fill: "#61AFF6" }} ></path>
                        <path d="M494.193,55.316l1.089-11.885c1.519-16.568-12.366-30.453-28.935-28.934l-11.885,1.089
	...
	C469.469,139.311,490.194,98.934,494.193,55.316z" style={{ fill: "#399AEA;" }}  ></path>
                        <path d="M400.892,56.26c-4.215-0.36-7.923,2.765-8.285,6.978c-0.36,4.214,2.765,7.924,6.978,8.285
	c22.969,1.966,36.702,15.7,38.667,38.667c0.161,1.871,0.981,3.528,2.213,4.76c1.542,1.542,3.729,2.418,6.071,2.218
	c4.215-0.361,7.339-4.07,6.978-8.285C450.92,78.531,431.246,58.856,400.892,56.26z" style={{ fill: "#FFFFFF" }}></path>
                        <path d="M446.539,117.17c4.215-0.361,7.339-4.07,6.978-8.285c-1.271-14.849-6.637-27.132-15.331-36.121
	c-2.36,4.942-4.957,9.768-7.785,14.46c4.392,6.071,7.067,13.778,7.853,22.967c0.161,1.871,0.981,3.528,2.213,4.76
	C442.01,116.493,444.197,117.371,446.539,117.17z" style={{ fill: "#CCDFED" }}></path>
                        <g>
                        </g>
                        <g>
                        </g>
